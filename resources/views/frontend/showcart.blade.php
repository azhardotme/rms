                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        -->
                            ...
                            <li class="scroll-to-section" style="background-color: rgb(230, 227, 51)">
                                @auth
            ...
            <div class="row">
                ...
                <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>
                            <input type="text" name="foodname[]" value=" {{$dataa->title}}" hidden="">
                            {{$dataa->title}}

                        </td>
                        <td>
                            <input type="text" name="quantity[]" value="{{$dataa->quantity}}" hidden="">
                            {{$dataa->quantity}}
                        </td>
                        <td>
                            <input type="text" name="price[]" value="{{$dataa->price}}" hidden="">
                            {{$dataa->price}} TK
                      ...
                      <tr style="position: relative; top:-65px; right:-930px;">
